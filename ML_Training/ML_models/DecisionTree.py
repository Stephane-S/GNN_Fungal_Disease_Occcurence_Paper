...
from sklearn.metrics import confusion_matrix, roc_auc_score, f1_score, accuracy_score, make_scorer
from statistics import mean, stdev

def DecisionTreeModel(sub_df, df_squamosa):
    # Split the dataset into training and test sets
    x_train, x_test, y_train, y_test = train_test_split(sub_df, df_squamosa, test_size=0.2, shuffle=True)
    ...
    # Calculate mean and standard deviation of metrics from cross-validation
    ...
    # Return cross-validation metrics and test metrics
